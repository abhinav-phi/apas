...
export default function Settings() {
  ...
  const handleLinkWallet = async () => {
    ...
    try {
      ...
      // Server-side verification is MANDATORY (audit P0): the edge function
      // recovers the signer from the signature itself. The bare
      // link_wallet_address RPC is revoked from clients because it never
      // verified signatures — falling back to it would reopen the
      // forgeable-wallet hole, so a function failure is a hard failure.
